...
.directive('adminPanelContent', ['$compile', '$templateRequest', function($compile, $templateRequest) {
    return {
        restrict: 'A',
        link: function($scope, $element) {
            ...
            $scope.$on('$viewContentLoaded', function() {
                ...
                //$templateRequest('client/components/footer/footer.tmpl.ng.html')
                ...
                //}, function() {
                //    console.error('Could not load footer template');
                //});
            });
        }
    };
