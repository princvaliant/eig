 ...
 * @description
 *
 * Creates a widget directive for use by other components
 *
 * @usage
 * ```html
...
angular.module('eigApp')
  .directive('widget', ['$mdTheming',
    function ($mdTheming) {
      return {
        restrict: 'E',
        templateUrl: 'client/components/widget/widget.tmpl.ng.html',
        transclude: true,
        replace: true,
        scope: {
          title: '@',
        ...
        link: function ($scope, $element, attrs) {
          ...
          $scope.contentLayout = attrs.contentLayout === undefined ? 'column' : attrs.contentLayout;
          ...
          $scope.contentLayoutAlign = attrs.contentLayoutAlign === undefined ? 'start top' : attrs.contentLayoutAlign;
