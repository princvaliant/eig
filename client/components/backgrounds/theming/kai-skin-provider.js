...
.provider('kaiSkins', ['$mdThemingProvider', 'kaiThemingProvider', 'APP', SkinsProvider])
.run(['$rootScope', 'kaiSkins', addSkinToScope]);

function SkinsProvider($mdThemingProvider, kaiThemingProvider, APP) {
    var skins = {};
    ...
    return {
        skin: function(id, name) {
            ...
            var skin = new Skin(id, name, $mdThemingProvider, kaiThemingProvider);
...
function Skin(id, name, $mdThemingProvider, kaiThemingProvider) {
    ...
    self.loadThemes = function() {
        ...
        for (var element in self.elements) {
            ...
            var theme = kaiThemingProvider.theme(self.elements[element]);
...
function addSkinToScope($rootScope, kaiSkins) {
    $rootScope.triSkin = kaiSkins.getCurrent();
}
